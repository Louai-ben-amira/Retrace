          ...
          <div className="flex items-center justify-between gap-3 mt-8 sm:mt-10">
            ...
            {step < 2 ? (
              <button
                ...
                className="bg-brand-500 text-ink text-sm font-semibold px-6 py-3 min-h-[44px] rounded-lg shadow-[0_0_24px_rgba(14,207,183,0.2)] hover:bg-brand-300 sm:hover:-translate-y-px transition-all duration-200"
              >
                Continue
              </button>
            ) : (
