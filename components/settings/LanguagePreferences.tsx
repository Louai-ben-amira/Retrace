      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <select
            ...
            disabled
            className="text-sm border border-white/15 rounded-lg px-3 py-2 bg-white/5 text-cream/50 disabled:cursor-not-allowed min-w-[160px]"
          >
    ...
    <div className="flex items-center justify-between gap-4">
      ...
      <div className="relative">
        <select
          ...
          disabled={loading}
          className="text-sm border border-white/15 rounded-lg px-3 py-2 bg-white/5 text-cream hover:border-white/25 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-colors disabled:opacity-50 min-w-[160px]"
        >
